  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pb-20">
      ...
      <div className="flex items-start gap-3 mb-6">
        <Users className="w-5 h-5 shrink-0 text-blue-600 mt-1" />
      ...
      <div className="flex items-start gap-3 mb-6">
        <Rocket className="w-5 h-5 shrink-0 text-purple-600 mt-1" />
        <p className="text-gray-700 leading-7">
      ...
      <div className="flex items-start gap-3 mb-6">
        <ShieldCheck className="w-5 h-5 shrink-0 text-green-600 mt-1" />
        <p className="text-gray-700 leading-7">
      ...
      <div className="mt-10 p-5 border rounded-xl bg-gray-50">
        <h2 className="text-lg font-semibold flex items-center gap-2 mb-2">
          <Gem className="w-5 h-5 shrink-0 text-emerald-600" />
          Premium Experience
        </h2>
